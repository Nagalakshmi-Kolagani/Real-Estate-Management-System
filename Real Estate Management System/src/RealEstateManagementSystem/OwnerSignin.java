...
public class OwnerSignin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        javaxSwingJLabel1.setText("Owner Signin");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, javaxSwingJPanel1Layout.createSequentialGroup()
                ...
                .addGroup(javaxSwingJPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javaxSwingJPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(113, 113, 113)
                        .addComponent(javaxSwingJButton2, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(82, 82, 82))
            .addGroup(javaxSwingJPanel1Layout.createSequentialGroup()
                .addGap(199, 199, 199)
                .addComponent(javaxSwingJLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 242, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void javaxSwingJButton1MouseClicked(java.awt.event.MouseEvent evt) {
        try{
            ...
            PreparedStatement check=conn.c.prepareStatement(check_st);
            check.setString(1,u);
            check.setString(2,p);
